...
const tracks: Array<{ id: ProductTrack; title: string; audience: string; description: string; details: string; capabilities: string[]; icon: typeof GraduationCap }> = [
  { id: 'academic_gd', title: 'Academic GD', audience: 'For teachers and evaluators', description: 'Assess group discussions with clear, evidence-based student reports.', details: 'Participants, rubrics, transcript evidence, and teacher review', capabilities: ['Rubrics', 'Evidence', 'Teacher review'], icon: GraduationCap },
  { id: 'industry', title: 'Industry Meetings', audience: 'For teams and managers', description: 'Turn team meetings into manager-approved decisions and assigned work.', details: 'Action items, owners, worksheets, and change requests', capabilities: ['Meetings', 'Tasks', 'Deadlines'], icon: UsersRound },
];
    ...
    <main className="track-selection" aria-labelledby="track-title">
      <section className="track-selection__shell">
        ...
        <div className="track-options">
          {tracks.map(({ id, title, audience, description, details, capabilities, icon: Icon }) => (
